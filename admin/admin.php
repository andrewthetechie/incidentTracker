...
function displayUsers(){
   global $database;
   $q = "SELECT username,userlevel,email,timestamp,rate "
   ...
   for($i=0; $i<$num_rows; $i++){
      ...
      $time   = date("M/d/Y h:i:s A", mysql_result($result,$i,"timestamp"));
...
User's Level: <br />
<input type="radio" name="userLevel" value="1" checked />User<br />
<input type="radio" name="userLevel" value="9" />Admin<br />
User's Billable Rate: <br />
